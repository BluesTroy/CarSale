...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><g:link controller="saleStatistic" action="saleCarStatistic">财务管理</g:link></li>
            <li class="active">汽车品牌销售统计</li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-6">
                <div class="box box-success text-center">
                    <div class="box-header with-border">
                        <h3 class="box-title">不同汽车品牌销售额统计</h3>
...
<script>
    ...
    $(function () {
        $.post("/saleStatistic/getSaleData",null, function (bdata) {
